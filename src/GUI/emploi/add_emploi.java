 ...
 * lundi_0,mardi_0,mercredi_0,jeudi_0,vendredi_0,samedi_0;
 ...
 * if (Integer.toString(c.getRef_niv()).charAt(0) ==
 * combobox_niveau.getSelectionModel().getSelectedItem().charAt(0))
 ...
 * emp.put("lundi_1" ,new Emploi(1,1)) ;emp.put("lundi_2",new Emploi(1,2))
 * ;emp.put("lundi_3",new Emploi(1,3)) ;emp.put("lundi_4",new Emploi(1,4));
 * emp.put("mardi_1" ,new Emploi(2,1)) ;emp.put("mardi_2",new Emploi(2,2))
 * ;emp.put("mardi_3",new Emploi(2,3)) ;emp.put("mardi_4",new Emploi(2,4));
 * emp.put("mercredi_1",new Emploi(3,1)) ;emp.put("mercredi_2",new
 * Emploi(3,2));emp.put("mercredi_3",new Emploi(3,3));emp.put("mercredi_4",new
 * Emploi(3,4));
 * emp.put("jeudi_1" ,new Emploi(4,1)) ;emp.put("jeudi_2",new Emploi(4,2))
 * ;emp.put("jeudi_3",new Emploi(4,3)) ;emp.put("jeudi_4",new Emploi(4,4));
 * emp.put("vendredi_1",new Emploi(5,1)) ;emp.put("vendredi_2",new
 * Emploi(5,2));emp.put("vendredi_3",new Emploi(5,3));emp.put("vendredi_4",new
 * Emploi(5,4));
 ...
 * if (i != null) {
 * listview_matieres.getItems().add(i.getNom() + i.getPrenom() + " - " +
 * dao_assiste.getNomMatiere(Integer.parseInt(s.getRef_m())));
 * }
 * }
 * }
 ...
 *
 * if (combobox_niveau.getSelectionModel().getSelectedIndex()==-1 ||
 * combobox_classe.getSelectionModel().getSelectedIndex()==-1){
 * Alert a = new Alert(AlertType.CONFIRMATION, "Veuillez Selectionner un niveau
 * et une classe avant d'ajouter l'emploi", ButtonType.OK);
 * a.showAndWait();
 * return ;
 * }
 *
 ...
 * {ok = false; blink_node(lundi_1.getParent(),flash);} else
 * dao_emploi.create(emp.get("lundi_1"));
 *
 * /*
 * if(dao_emploi.Existe(emp.get("lundi_1")) ||
 * dao_emploi.create(emp.get("lundi_1"))!=-2)
 * if(dao_emploi.Existe(emp.get("lundi_2")) ||
 * dao_emploi.create(emp.get("lundi_2"))!=-2) {ok =
 * false;blink_node(lundi_2.getParent(),flash);}
 * if(dao_emploi.Existe(emp.get("lundi_3"))) {ok = false;
 * blink_node(lundi_3.getParent(),flash);} else
 * dao_emploi.create(emp.get("lundi_3"));
 * if(dao_emploi.Existe(emp.get("lundi_4"))) {ok = false;
 * blink_node(lundi_4.getParent(),flash);} else
 * dao_emploi.create(emp.get("lundi_4"));
 *
 * if(dao_emploi.Existe(emp.get("mardi_1"))) {ok =
 * false;blink_node(mardi_1.getParent(),flash);} else
 * dao_emploi.create(emp.get("mardi_1"));
 * if(dao_emploi.Existe(emp.get("mardi_2"))) {ok =
 * false;blink_node(mardi_2.getParent(),flash);} else
 * dao_emploi.create(emp.get("mardi_2"));
 * if(dao_emploi.Existe(emp.get("mardi_3"))) {ok =
 * false;blink_node(mardi_3.getParent(),flash);} else
 * dao_emploi.create(emp.get("mardi_3"));
 * if(dao_emploi.Existe(emp.get("mardi_4"))) {ok =
 * false;blink_node(mardi_4.getParent(),flash);} else
 * dao_emploi.create(emp.get("mardi_4"));
 *
 * if(dao_emploi.Existe(emp.get("mercredi_1"))) {ok =
 * false;blink_node(mercredi_1.getParent(),flash);} else
 * dao_emploi.create(emp.get("mercredi_1"));
 * if(dao_emploi.Existe(emp.get("mercredi_2"))) {ok =
 * false;blink_node(mercredi_2.getParent(),flash);} else
 * dao_emploi.create(emp.get("mercredi_2"));
 * if(dao_emploi.Existe(emp.get("mercredi_3"))) {ok =
 * false;blink_node(mercredi_3.getParent(),flash);} else
 * dao_emploi.create(emp.get("mercredi_3"));
 * if(dao_emploi.Existe(emp.get("mercredi_4"))) {ok =
 * false;blink_node(mercredi_4.getParent(),flash);} else
 * dao_emploi.create(emp.get("mercredi_4"));
 *
 * if(dao_emploi.Existe(emp.get("jeudi_1"))) {ok =
 * false;blink_node(jeudi_1.getParent(),flash);} else
 * dao_emploi.create(emp.get("jeudi_1"));
 * if(dao_emploi.Existe(emp.get("jeudi_2"))) {ok =
 * false;blink_node(jeudi_2.getParent(),flash);} else
 * dao_emploi.create(emp.get("jeudi_2"));
 * if(dao_emploi.Existe(emp.get("jeudi_3"))) {ok =
 * false;blink_node(jeudi_3.getParent(),flash);} else
 * dao_emploi.create(emp.get("jeudi_3"));
 * if(dao_emploi.Existe(emp.get("jeudi_4"))) {ok =
 * false;blink_node(jeudi_4.getParent(),flash);} else
 * dao_emploi.create(emp.get("jeudi_4"));
 *
 * if(dao_emploi.Existe(emp.get("vendredi_1"))) {ok =
 * false;blink_node(vendredi_1.getParent(),flash);} else
 * dao_emploi.create(emp.get("vendredi_1"));
 * if(dao_emploi.Existe(emp.get("vendredi_2"))) {ok =
 * false;blink_node(vendredi_2.getParent(),flash);} else
 * dao_emploi.create(emp.get("vendredi_2"));
 * if(dao_emploi.Existe(emp.get("vendredi_3"))) {ok =
 * false;blink_node(vendredi_3.getParent(),flash);} else
 * dao_emploi.create(emp.get("vendredi_3"));
 * if(dao_emploi.Existe(emp.get("vendredi_4"))) {ok =
 * false;blink_node(vendredi_4.getParent(),flash);} else
 * dao_emploi.create(emp.get("vendredi_4"));
 *
 * if(dao_emploi.Existe(emp.get("samedi_1"))) {ok =
 * false;blink_node(samedi_1.getParent(),flash);} else
 * dao_emploi.create(emp.get("samedi_1"));
 * if(dao_emploi.Existe(emp.get("samedi_2"))) {ok =
 * false;blink_node(samedi_2.getParent(),flash);} else
 * dao_emploi.create(emp.get("samedi_2"));
 *
 * if (!ok){
 ...
 * listview_matieres.getSelectionModel().getSelectedItem().substring(0,
 * listview_matieres.getSelectionModel().getSelectedItem().indexOf(" -"));
 ...
 * for (int i=0;i<all.size();i++){
 * if
 * (listview_salles.getSelectionModel().getSelectedItem().equals(all.get(i).getType_salle())){
