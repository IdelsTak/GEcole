...
public class list_emploi implements Initializable {
    ...
    @FXML
    private TableColumn<Emploi, String> colonne_total_heures, colonne_nom_classe, colonne_niveau_classe, colonne_nom_salle;
    @FXML
    private TableColumn<Emploi, String> colonne_capacite, colonne_capacite_classe, colonne_capacite_salle, colonne_actions;
    @FXML
    private JFXComboBox<String> combobox_classe, combobox_niveau, combobox_instituteur, combobox_salle;
