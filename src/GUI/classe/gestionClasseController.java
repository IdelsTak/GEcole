...
public class gestionClasseController implements Initializable {
    ...
    private void click_chercher(ActionEvent event) {
        ...
        /*
         *
         * FilteredList<Classe> filteredData = new FilteredList<>(masterData, p
         * -> true);
         *
         ...
         * });
         *
         * niveau.getEditor().textProperty().addListener((observable, oldValue,
         * newValue) -> {
         * filteredData.setPredicate(classe -> {
         *
         * if (newValue == null || newValue.isEmpty()) {
         ...
         * });
         *
         * capacite.getEditor().textProperty().addListener((observable,
         * oldValue, newValue) -> {
         * filteredData.setPredicate(classe -> {
         *
         * if (newValue == null || newValue.isEmpty()) {
